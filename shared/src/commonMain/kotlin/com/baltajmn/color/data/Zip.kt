...
/**
 * STORED only, written straight to [sink] entry by entry: a journal with photos is bigger than the
 ...
 * over. Anything that does not add up is refused whole: half an imported journal is worse than none.
 */
